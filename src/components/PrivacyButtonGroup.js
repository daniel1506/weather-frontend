...
function PrivacyButtonGroup(props) {
  return (
    <ToggleButtonGroup exclusive aria-label="privacy" {...props}>
      ...
      <SquareToggleButton value="friends-of-friends" aria-label="friends-of-friends">
        <Tooltip title="Even friends of your friends can view this event">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" style={{ width: 24, height: 24 }}>
            <path
              fill="#757575"
      ...
      <SquareToggleButton value="public" aria-label="public">
        <Tooltip title="Everyone can view this event">
          <PublicIcon />
        </Tooltip>
      </SquareToggleButton>
    </ToggleButtonGroup>
